...
void main()
{
    ...
    waves[7] = waveInfo(5.f,   .05f, 0.02f,normalize(vec2(.8f,1.2f)),0.f);
    waves[8] = waveInfo(0.5f,  .10f, .7f,normalize(vec2(1.1f,.8f)),.0f);
    waves[9] = waveInfo(2.f,  .07f, .28f,normalize(vec2(1.25f,-.75f)), 0.f);
...
//-----------
	...
	positionOutput += 1.0f/numWaves * getWaveContribution(positionOutput.x,positionOutput.z,waveTime, waves[0]);
    }
